...
amrExport.AMRSdkConfig = function (config, successCallback, failureCallback) {
    if (typeof config === 'object' && typeof config.amrAppId === 'string' && config.amrAppId.length > 0) {
        cordova.exec(successCallback, failureCallback, 'Amr', 'AMRSdkConfig', [config]);
    } else {
...
amrExport.startWithConfig = function (config, successCallback, failureCallback) {
    cordova.exec(successCallback, failureCallback, 'Amr', 'startWithConfig', [config]);
};
...
amrExport.setCanRequestAds = function (config, successCallback, failureCallback) {
    cordova.exec(successCallback, failureCallback, 'Amr', 'setCanRequestAds', [config]);
};

amrExport.startTestSuite = function (config, successCallback, failureCallback) {
    cordova.exec(successCallback, failureCallback, 'Amr', 'startTestSuite', [config]);
};

amrExport.loadBanner = function (config, successCallback, failureCallback) {
    if (typeof config === 'undefined' || config == null) config = {};
    cordova.exec(successCallback, failureCallback, 'Amr', 'loadBanner', [config]);
};
...
amrExport.destroyBanner = function (config, successCallback, failureCallback) {
    if (typeof config === 'undefined' || config == null) config = {};
    cordova.exec(successCallback, failureCallback, 'Amr', 'destroyBanner', []);
};

amrExport.destroyInterstitial = function (config, successCallback, failureCallback) {
    if (typeof config === 'undefined' || config == null) config = {};
    cordova.exec(successCallback, failureCallback, 'Amr', 'destroyInterstitial', []);
};

amrExport.destroyRewardedVideo = function (config, successCallback, failureCallback) {
    if (typeof config === 'undefined' || config == null) config = {};
...
amrExport.loadInterstitial = function (config, successCallback, failureCallback) {
    if (typeof config === 'undefined' || config == null) config = {};
    cordova.exec(successCallback, failureCallback, 'Amr', 'loadInterstitial', [config]);
};
...
amrExport.showInterstitial = function (show, successCallback, failureCallback) {
    ...
    cordova.exec(successCallback, failureCallback, 'Amr', 'showInterstitial', [show]);
};

amrExport.loadRewardedVideo = function (config, successCallback, failureCallback) {
    if (typeof config === 'undefined' || config == null) config = {};
    cordova.exec(successCallback, failureCallback, 'Amr', 'loadRewardedVideo', [config]);
};
...
amrExport.showRewardedVideo = function (tag, successCallback, failureCallback) {
    ...
    cordova.exec(successCallback, failureCallback, 'Amr', 'showRewardedVideo', [tag]);
};

amrExport.loadAndShowRewardedVideo = function (config, successCallback, failureCallback) {
    if (typeof config === 'undefined' || config == null) config = {};
    cordova.exec(successCallback, failureCallback, 'Amr', 'loadAndShowRewardedVideo', [config]);
};
